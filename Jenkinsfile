          ...
          steps{
            ...
            dir('charts') {
              ...
              sh '/usr/local/bin/helm package webapp'
               sh 'curl -u$username:$password  -T /home/ec2-user/workspace/job/charts/webapp-1.0.tgz "https://kenappiah.jfrog.io/artifactory/ken-helm-helm-local/webapp-1.0.tgz"'
              }
